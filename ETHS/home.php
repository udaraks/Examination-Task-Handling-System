...
<title>Examination Task Handling System: Home</title>
...
<a href="logout.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('logout','','Buttons/log3.jpg',1)"><img src="Buttons/log2.jpg" alt="Log Out" name="logout" width="180" height="40" border="0" id="logout" /></a></td>
	...
	{
		if(isset($_SESSION['users']['stdName'])) // when a student logins
		{
			echo("Welcome! "."<b>".$_SESSION['users']['stdName']."</b><br />");
		}
		else if(isset($_SESSION['users']['lectName'])) // when a lecturer logins
		{
			echo("Welcome! "."<b>".$_SESSION['users']['lectName']."</b><br />");
		}
		
	?>
	<br />
	 To change your password <a href="changepass.php"><em> CLICK HERE</em></a> <p> Click on the buttons to the left of the page to visit the relevant pages      </td>
  </tr>
</table>
<br /><br /><br /><br />
<p class="style2">&nbsp;</p>
