...
<a href="logout.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('logout','','Buttons/log3.jpg',1)"><img src="Buttons/log2.jpg" alt="Log Out" name="logout" width="180" height="40" border="0" id="logout" /></a></td>
    <td><h2>EXAMINATION TIMETABLE</h2><br />
<?php
...
{
?>
    <p>Check your Examination Time Table in this page according to given criteria</p>
    <br />
    <ul>
    <li>By Subject Type (<em>Physics,Chemistry, ...</em>)</li>
    <li>By Course Level (<em>100,200, ...</em>)</li>
    </ul>
...
<td><select name="level" class="style6" >
	<option>ALL</option>
    <option>100</option>
    <option>200</option>
    <option>300</option>
...
<?php
	...
	echo "</select>";
?>
	<input type='submit' value='Check Exam Time Table' name ='btncheck' class='style6' 
	align="center" />
	</td></tr></table>
